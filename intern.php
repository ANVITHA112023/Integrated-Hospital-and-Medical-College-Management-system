...
<body>
    <div class="login-container">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "SELECT * FROM intern WHERE username = ? AND password1 = ?";
        ...
        echo "<div class='success'><a href='intern1.html' style='color: #007BFF; text-decoration: none; font-weight: bold;'>View intern table</a></div>";
            } else {
